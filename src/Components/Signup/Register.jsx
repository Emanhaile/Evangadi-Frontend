...
function Register() {
  ...
  return (
    <section className=" banner w-full mb-4 flex flex-col md:flex-row items-start  justify-center  bg-[#F5F5F5] p-5 ">
      {/* Registration Form */}
      ...
      {/* Description Section */}
      <div className="w-full max-w-md mx-auto my-auto p-4 ">
        <h6 className="text-[#ff8500] font-semibold mb-2">About</h6>
